...
public class Data {
  ...
  public static final String[] nomesMeses = {"Janeiro", "Fevereiro", "Março", "Abril", "Maio", "Junho", "Julho", "Agosto", "Setembro", "Outobro", "Novembro", "Dezembro"};
  ...
  public String extenso() {
    return dia + mesExtenso() + "de" + ano;
  }

  /** Indica se um terno (dia, mes, ano) forma uma data válida. */
  public static boolean dataValida(int dia, int mes, int ano) {
    if(mes < 0 || mes > 12) return false;
    if(dia < 0 || dia > diasDoMes(mes, ano)) return false;
